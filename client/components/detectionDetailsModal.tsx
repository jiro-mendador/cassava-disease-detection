...
const DetectionDetailsModal = ({ data, visible, onClose }) => {
  return (
    <Modal visible={visible} transparent={true} animationType="fade">
      <View className="flex-1 bg-black/80 flex flex-col gap-12">
        {/* Close button */}
        <TouchableOpacity
          onPress={onClose}
        ...
        <View className="bg-black p-10 w-[90%] self-center border border-gray-400 rounded-xl flex gap-4">
          <View className="rounded-xl mb-4">
            <Image
              ...
              className="w-[100%] h-[15rem] rounded-xl"
              resizeMode="contain"
            />
          </View>
          ...
          <TouchableOpacity className="border bg-[#bded30] border-[#bded30] rounded-full p-4 mt-6">
